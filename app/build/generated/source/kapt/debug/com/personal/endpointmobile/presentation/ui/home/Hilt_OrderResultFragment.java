...
public abstract class Hilt_OrderResultFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_OrderResultFragment() {
    super();
  }

  Hilt_OrderResultFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OrderResultFragment_GeneratedInjector) this.generatedComponent()).injectOrderResultFragment(UnsafeCasts.<OrderResultFragment>unsafeCast(this));
    }
  }
