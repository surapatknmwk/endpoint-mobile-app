...
public abstract class Hilt_SearchResultFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SearchResultFragment() {
    super();
  }

  Hilt_SearchResultFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SearchResultFragment_GeneratedInjector) this.generatedComponent()).injectSearchResultFragment(UnsafeCasts.<SearchResultFragment>unsafeCast(this));
    }
  }
